...
export default function GoogleSign() {
	...
	const sendData = async () => {
		window.location.href = "http://e3r10p12.1337.ma:3000/login/google";
	};

	return (
		<>
			<button type="button" className="flex flex-row w-80 space-x-1 pl-16 pr-1 pt-4 pb-4 border border-black rounded-[10px] hover:shadow-[0px_0px_8px_rgba(0,0,0,0.4)]"  onClick={sendData} >

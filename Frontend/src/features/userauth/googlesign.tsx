export default function GoogleSign() {
	...
	return (
		<>
			<button type="button" className="flex flex-row space-x-2 pl-20 pr-20 pt-4 pb-4 border border-black rounded-[10px] hover:shadow-[8px_8px_0px_0px_black]"  onClick={sendData} >

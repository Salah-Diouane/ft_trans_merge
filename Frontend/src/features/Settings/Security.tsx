      ...
      <div className="mt-20 flex justify-center w-full max-w-[1100px] font-russo">
        <div className="flex flex-col space-y-10">
          <input
            ...
            className="w-full bg-[#222831] placeholder-white text-white p-3 rounded-[10px] outline-none"
            ref={oldpassowrd}
          />
          <input
            type="password"
          ...
          <div className="flex flex-row space-x-2">
            ...
            <label className="relative inline-flex items-center cursor-pointer outline-none">
              <input
                type="checkbox"
                checked={twofavalue}
                onChange={(e) => settwofavalue(e.target.checked)}
          ...
          <button
            className="w-full border text-white border-transparent bg-blue-600 rounded-[10px] hover:text-[#0077FF] hover:bg-transparent hover:border-[#0077FF] transition p-2"
            onClick={Fecthdata}
          >
            Save
          </button>

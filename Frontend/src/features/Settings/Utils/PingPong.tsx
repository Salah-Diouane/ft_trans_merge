  ...
  return (
    <>
      ...
      <div className="flex flex-col sm:flex-row justify-end sm:pr-10 pt-7 gap-4 text-white">
        <button
          className="w-full sm:w-[201px] h-[41px] border border-transparent bg-blue-600 rounded-[10px] hover:text-[#0077FF] hover:bg-transparent hover:border-[#0077FF] transition"
          onClick={resetPingPongDefault}
        >
          Reset Default
        </button>
        <button
          className="w-full sm:w-[133px] h-[41px] border border-transparent bg-blue-600 rounded-[10px] hover:text-[#0077FF] hover:bg-transparent hover:border-[#0077FF] transition"
          onClick={sendData}
        >
          Save
        </button>

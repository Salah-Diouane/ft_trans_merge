...
interface Messageprops {
    ...
    handleThreeDotsClick: (messageId: string | number, e: React.MouseEvent) => void;
...
const Messages: React.FC<Messageprops> = ({ messages, loggedInUserId, handleThreeDotsClick, showMenu, setShowMenu, handleDeleteClick }) => {

  ...
  return (
    <div className="relative w-full h-full bg-[#222831] rounded-2xl max-lg:h-[91%] overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-0 right-1/4 w-40 h-40 bg-[#0077FF]/2 rounded-full blur-3xl"></div>
        {/* <div className="absolute top-1/2 left-0 w-2 h-24 bg-[#0077FF]/20 rounded-r-full"></div> */}
        {/* <div className="absolute top-1/3 right-0 w-2 h-32 bg-[#0077FF]/20 rounded-l-full"></div> */}
      </div>
      ...
      <div className="relative z-10 p-8 lg:p-16 h-full flex flex-col">
        ...
        <div className="text-center mb-12 lg:mb-16">
          <div className="relative inline-block mb-6">
            <h1 className="text-6xl lg:text-7xl font-russo text-white tracking-wider relative">
              PONG
            </h1>
            ...
            <div className="group relative">
              ...
              >
                ...
                <div className="text-center space-y-4 w-full">
                  ...
                  <p className="text-[#EEEEEE]/70 text-sm lg:text-base leading-relaxed">

...
// <div className="absolute transform -translate-x-1/2 -bottom-4 left-1/2 h-[80%] justify-center hidden md:flex">
// 	<svg
// 		viewBox="0 0 207 110"
// 	>
// 		<path
...
// <div className="absolute top-0 right-0 z-20 h-full w-[25%] justify-end hidden md:flex">
// 	<svg

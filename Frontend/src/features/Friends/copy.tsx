...
const SectionFriendSend: React.FC = () => {
    ...
    return (
        <div className='flex  items-center w-full p-2 xs:p-4 bg-[#222831] m-2 h-16 rounded-3xl border border-[#393E46]/50 hover:border-[#0077FF]/50 transition-all duration-300 justify-between'>
            ...
            <div className="flex flex-row items-center gap-2 flex-1">
                <button className="flex-1 h-full bg-[#0077FF] text-white rounded-full text-xs font-semibold hover:bg-opacity-80 transition-colors flex items-center justify-center gap-2">
                    <Clock size={14} />
                    Request Sent
                </button>
                <button className="flex-1 h-full bg-red-500 text-white rounded-full text-xs font-semibold hover:bg-opacity-80 transition-colors flex items-center justify-center gap-2">
                    <X size={16} />
                    Cancel
                </button>
            </div>
...
const SectionFriendRequest: React.FC = () => {
    ...
    return (
        ...
        <div className='flex items-center p-0 xs:p-4 bg-[#222831] p-2 m-2 h-16 rounded-3xl border border-[#393E46]/50 hover:border-[#0077FF]/50 transition-all duration-300 justify-between'>
            <div className="flex items-center gap-2 xs:gap-4 flex-shrink min-w-0">
                <img
                    src={store.image_url}
                    className="size-8 xs:size-10 sm:size-12 rounded-full border-2 border-white flex-shrink-0"
...
const All: React.FC = () => {
    return (
        ...
        <div className='flex flex-col font-russo text-base sm:text-lg bg-[#393E46]'>
...
const Sent: React.FC = () => {
    return (
        <div className='flex flex-col font-russo text-base sm:text-lg bg-[#393E46] pr-4'>
            <div className="sticky top-0 z-10  px-14  pt-4 pb-4  ">
                <div className="flex items-center bg-[#222831] rounded-full px-4 h-12 shadow-md ">
                    <Search className="text-gray-400 mr-2" size={20} />
                    <input
...
const Friends: React.FC = () => {
    ...
    return (
        <div className="pt-4 flex justify-center px-4 sm:px-6 " >

            <div className="max-w-7xl mx-auto h-full flex flex-col max-md:p-0">

                <div className=" w-full h-6 rounded-2xl flex flex-row justify-center gap-4 items-center " >

                    <div
                        className={`${allClicked ? "text-blue-600 border-b-2 border-blue-600 pb-1" : "text-white hover:text-blue-600"} cursor-pointer font-russo text-sm flex items-center gap-1`}
                    ...
                    <div
                        className={`${onlineClicked ? "text-blue-600 border-b-2 border-blue-600 pb-1" : "text-white hover:text-blue-600"} cursor-pointer font-russo text-sm flex items-center gap-1`}
                    ...
                    <div
                        className={`${requestClicked ? "text-blue-600 border-b-2 border-blue-600 pb-1" : "text-white hover:text-blue-600"} cursor-pointer font-russo text-sm flex items-center gap-1`}
                    ...
                    <div
                        className={`${blockClicked ? "text-blue-600 border-b-2 border-blue-600 pb-1" : "text-white hover:text-blue-600"} cursor-pointer font-russo text-sm flex items-center gap-1`}

...
// const All: React.FC = () => {
//     return (
//         <div className='bg-[#393E46] w-full h-[93%] mt-7 rounded-2xl p-4 overflow-hidde'>
...
//     return (
//         // <div className="pt-20 bg-[#222831] flex justify-center  sm:text-lg px-4 sm:px-10" >
//         <div className="w-full    bg-[#222831] sm:p-11 md:max-lg:pl-4 md:bg-white md:max-lg:p-2 md:max-lg:pt-12 max-sm:w-[65%] max-sm:pr-2 max-sm:pl-0 smx:w-[100%] smx:pt-3 xs:p-1 xs:pt-3 max-sm:p-10  " >
//             <div className=" mx-auto h-full flex flex-col  xs:overflow-hidden  ">
//                 <div className=" w-full h-6 rounded-2xl flex justify-center gap-24 p-2 items-center max-sm:gap-7  " >
//                     <div
...
const FriendCard: React.FC<FriendCardProps> = ({ name, isOnline, type }) => {
    ...
    return (
        <div className='flex items-center justify-items-center p-2 xs:p-3 sm:p-4 bg-[#222831] m-1 xs:m-2 h-auto sm:h-16 rounded-2xl border border-[#393E46]/50 hover:border-[#0077FF]/50  '>
            <div className="flex items-start gap-3 xs:gap-4 w-1/6">
                <img src={store.image_url} alt="player profile" className="w-12 h-12 rounded-full border-2 border-white"/>
                <div className="flex flex-col h-12">
                    <strong className="text-white text-sm xs:text-base sm:text-lg font-bold">{name}</strong>
                    <strong className="text-gray-400 text-xs xs:text-sm flex items-center gap-1 xs:gap-2">
            ...
            <div className='flex flex-1 items-center justify-end gap-2 xs:gap-3'>
                {type === 'all' && (
                    <button className="bg-[#0077FF] text-white py-1 px-3 xs:py-2 xs:px-4 rounded-full text-xs xs:text-sm font-semibold hover:bg-opacity-80 transition-colors flex items-center gap-1 xs:gap-2">
                ...
                {type === 'sent' && (
                    <>
                        ...
                        <button className="bg-red-500 text-white py-1 px-3 xs:py-2 xs:px-4 rounded-full text-xs xs:text-sm font-semibold hover:bg-opacity-80 transition-colors flex items-center gap-1 xs:gap-2">
                            <X size={16}/> Cancel
                        </button>
                    </>
                )}
                ...
                {type === 'blocked' && (
                    <button className="bg-blue-500 text-white py-1 px-3 xs:py-2 xs:px-4 rounded-full text-xs xs:text-sm font-semibold hover:bg-opacity-80 transition-colors flex items-center gap-1 xs:gap-2">
...
const Section: React.FC<SectionProps> = ({ type }) => (
    <div className='bg-[#393E46] w-full h-[93%] mt-4 xs:mt-6 xs:p-4  rounded-2xl p-2 overflow-auto'>
        <div className="sticky top-0 z-10 px-2 xs:px-4 sm:px-8 pt-2 xs:pt-4 pb-2 xs:pb-4">
    ...
    return (
        ...
        <div className="w-full bg-[#222831]  xs:p-3 sm:p-4 md:p-6 lg:p-8 xl:p-10">
            <div className="mx-auto h-full flex flex-col">
                ...
                <div className="w-full h-6 rounded-2xl flex justify-center gap-2 xs:gap-4 sm:gap-6 md:gap-8 lg:gap-12 p-1 xs:p-2">
